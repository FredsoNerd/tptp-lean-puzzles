...
% Status   : Theorem
% Rating   : 0.12 v7.3.0, 0.17 v7.1.0, 0.00 v6.3.0, 0.14 v6.2.0, 0.50 v6.1.0, 0.67 v6.0.0, 0.71 v5.5.0, 0.78 v5.4.0, 0.75 v5.3.0, 0.70 v5.2.0, 0.83 v5.1.0, 0.80 v5.0.0
% Syntax   : Number of formulae    :   12 (   2 unit;   6 type)
...
%            Arithmetic symbols    :   13 (   1 prd;   2 fun;   1 num;   9 var)
% SPC      : TF0_THM_EQU_ARI
