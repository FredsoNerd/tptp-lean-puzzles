...
tff(pel47_7, axiom, ![X1:animal]:(![X2:plant]:eats(X1,plant_to_edible(X2))|![X3:animal]:((much_smaller(X3,X1)&?[X4:plant]:eats(X3,plant_to_edible(X4)))=>eats(X1,animal_to_edible(X3)))), file('tff_puzzles/PUZ030_1.p', pel47_7)).
tff(pel47_14a, axiom, ![X20:snail]:?[X19:plant]:eats(snail_to_animal(X20),plant_to_edible(X19)), file('tff_puzzles/PUZ030_1.p', pel47_14a)).
tff(pel47, conjecture, ?[X21:animal, X22:animal, X23:grain]:(eats(X22,plant_to_edible(grain_to_plant(X23)))&eats(X21,animal_to_edible(X22))), file('tff_puzzles/PUZ030_1.p', pel47)).
tff(pel47_8, axiom, ![X5:snail, X6:bird]:much_smaller(snail_to_animal(X5),bird_to_animal(X6)), file('tff_puzzles/PUZ030_1.p', pel47_8)).
tff(pel47_13, axiom, ![X15:bird, X17:snail]:~(eats(bird_to_animal(X15),animal_to_edible(snail_to_animal(X17)))), file('tff_puzzles/PUZ030_1.p', pel47_13)).
tff(pel47_9, axiom, ![X8:bird, X9:fox]:much_smaller(bird_to_animal(X8),fox_to_animal(X9)), file('tff_puzzles/PUZ030_1.p', pel47_9)).
tff(pel47_10, axiom, ![X10:fox, X11:wolf]:much_smaller(fox_to_animal(X10),wolf_to_animal(X11)), file('tff_puzzles/PUZ030_1.p', pel47_10)).
tff(pel47_11a, axiom, ![X12:wolf, X14:grain]:~(eats(wolf_to_animal(X12),plant_to_edible(grain_to_plant(X14)))), file('tff_puzzles/PUZ030_1.p', pel47_11a)).
